...
<head>
	...
	<title>Edit Data Peminjaman Buku Lazaris</title>
</head>
<body>
	<div class="container">
			...
			<div class="col-md-6">
				...
				<div class="card">
					<div class="card-header">
						Edit Peminjaman Buku Lazaris
					</div>
					<div class="card-body">
						<form action="" method="post">
							<input type="hidden" name="kode" value="<?= $peminjaman['Kode_pinjam'] ?>">
							<div class="form-group">
								<label for="kodepinjam">Kode pinjam</label>
								<input type="text" name="kodepinjam" class="form-control" id="kodepinjam" value="<?= $peminjaman['Kode_pinjam'] ?>">
								<small id="emailHelp" class="form-text text-danger"><?= form_error('kodepinjam'); ?></small>
							</div>
							<div class="form-group">
								<label for="tanggal">Tanggal pinjam</label>
								<input type="date" name="tanggal" class="form-control" id="tanggal" value="<?= $peminjaman['tgl_pinjam'] ?>">
								<small id="emailHelp" class="form-text text-danger"><?= form_error('tanggal'); ?></small>
							</div>
							<div class="form-group">
								<label for="idpetugas">ID petugas</label>
								<input type="text" name="idpetugas" class="form-control" id="idpetugas" value="<?= $peminjaman['ID_petugas'] ?>">
								<small id="emailHelp" class="form-text text-danger"><?= form_error('idpetugas'); ?></small>
							</div>
							<div class="form-group">
								<label for="idanggota">ID anggota</label>
								<input type="text" name="idanggota" class="form-control" id="idanggota" value="<?= $peminjaman['ID_anggota'] ?>">
								<small id="emailHelp" class="form-text text-danger"><?= form_error('idanggota'); ?></small>
							</div>
							<div class="form-group">
								<label for="kodebuku">Kode buku</label>
								<input type="text" name="kodebuku" class="form-control" id="kodebuku" value="<?= $peminjaman['Kode_buku'] ?>">
