...
<head>
	...
	<title>Edit Data Buku Lazaris</title>
</head>
<body>
	<div class="container">
				...
				<div class="card">
					...
					<div class="card-body">
						<form action="" method="post">
							<input type="hidden" name="kode" value="<?= $buku['Kode_buku'] ?>">
							<div class="form-group">
								<label for="kodebuku">Kode Buku</label>
								<input type="text" name="kodebuku" class="form-control" id="kodebuku" value="<?= $buku['Kode_buku'] ?>">
							...
							<div class="form-group">
								...
								<input type="text" name="no_rak" class="form-control" id="no_rak" value="<?= $buku['no_rak'] ?>">
